...
Let's help them fix those typos by writing a function that will take two arguments (`voter` and `correct_house_number`) and change the `voter`'s  `house_number` to be the `correct_house_number`. 
