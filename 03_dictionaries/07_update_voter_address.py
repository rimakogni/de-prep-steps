"""
Uh-oh! We've got some voters who've registered their addresses incorrectly! Let's help them fix those typos by writing a function that will take two arguments (`voter` and `correct_house_number`) and change the `voter`'s  `house_number` to be the `correct_house_number`. 
