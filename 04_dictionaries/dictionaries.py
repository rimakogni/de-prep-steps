...
def add_attribute_to_product(product, key, value):
   ...
   allowed_key_types = (str,int,float,bool)
...
def get_northcoders_names(northcoders):
    ...
    for northcoder in northcoders:
        if isinstance(northcoder,dict) and 'name' in northcoder:
            list_northcoders.append(northcoder['name'])
    return list_northcoders
    pass
