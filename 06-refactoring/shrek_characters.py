"""
shrek_characters is a function that takes a list of movie characters and returns a list of only the characters from the film franchise, Shrek.
...
def test_all_characters_if_all_in_shrek():
    ...
    assert shrek_characters(characters) == ['Shrek', 'Lord Farquaad', 'Magic Mirror']
...
def test_returns_any_characters_from_shrek_franchise():
    ...
    assert shrek_characters(characters) == ['Fiona', 'Fairy Godmother', 'Cookie', 'Puss In Boots']