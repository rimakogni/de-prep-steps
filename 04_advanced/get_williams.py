"""
Write a function that takes a list of `names` representing a person's full name and returns a list 
of each person whose last name is 'Williams'.


get_williams(['David Williams']) # returns ['David Williams']

get_williams(['David Williams', 'Sarah Williams']) # returns ['David Williams', 'Sarah Williams']
...
def test_several_valid_items():
    assert get_williams(['David Williams', 'Sarah Williams']) == ['David Williams', 'Sarah Williams']


def test_mixed_items():
    assert get_williams(['Kirsty February', 'Sam Williams']) == ['Sam Williams']
