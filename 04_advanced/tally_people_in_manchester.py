...
tally_people_in_manchester([{ 'name': 'Emmeline', 'lives': { 'country': 'UK', 'city': 'Manchester' }, 'age': 32 }]) # returns 1

tally_people_in_manchester([{ 'name': 'Carrie', 'lives': { 'country': 'UK', 'city': 'Leeds' }, 'age': 32 }]) # returns 0

tally_people_in_manchester([{ 'name': 'Carrie', 'lives': { 'country': 'UK', 'city': 'Leeds' }, 'age': 32 }, { 'name': 'Ray', 'lives': { 'country': 'UK', 'city': 'Manchester' }, 'age': 31 }]) # returns 1
...
def test_single_person_not_in_manchester():
    people = [{ 'name': 'Carrie', 'lives': { 'country': 'UK', 'city': 'Leeds' }, 'age': 32 }]
    assert tally_people_in_manchester(people) == 0


def test_single_person_in_manchester():
    people = [{ 'name': 'Emmeline', 'lives': { 'country': 'UK', 'city': 'Manchester' }, 'age': 32 }]
