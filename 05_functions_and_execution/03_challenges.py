...
def read_traffic_light(traffic_light_colour):
    colour = traffic_light_colour.lower()
...
def how_many_arguments(*numbers):
    return len(numbers)
    pass
