...
class SkipCheck:
    ...
    def is_same_as(self, original_input):
        print(f"{BOLD_YELLOW}{self.func.__name__}(){NORMAL_YELLOW}, Test {self.title}: skipping test...{DEFAULT}")
    ...
    def is_not_same_as(self, original_data):
        ...
        if self.return_value is not original_data:
            ...
            feedback_msg = (
                ...
                f"failed, return value should be a new {type(original_data).__name__}{DEFAULT}"
            )
    ...
    def is_type(self, data_type):
        ...
        if isinstance(self.return_value, data_type):
            ...
            feedback_msg = (
                ...
                f"value should be of type {self.return_value.__class__.__name__}{DEFAULT}"
            )
    ...
    def returns(self, expected_return_value):
        ...
        if self.return_value == expected_return_value:
            ...
            feedback_msg = (
                ...
                f"expected {expected_return_value}, but received {self.return_value}{DEFAULT}"
            )
